...
<body>
    ...
    <div class="lesson-contanier" > 
    	<div class="lesson-center">
        	<div class="lesson-ssnav"><a href="index.html">首页</a><i></i><a href="kecheng.html">课程</a><i></i><span>心理知识微课堂</span>
            <i></i><span>管理学院&nbsp;&nbsp;五平方米的世界</span></div>
        	<div class="lesson-vedioModel">
            	<div class="lesson-vedioName">
                	<span>管理学院&nbsp;&nbsp;五平方米的世界</span>
                </div>
                <div class="lesson-vedioTag">
                	<video controls src= "video/dhfinal/1.mp4" poster="img/glxy.jpg">
                    </video>
                </div>
            </div>
            <!-- 视频部分结束-->
            <div class="lesson-spjj">
                ...
                <div><p>五平方米的世界是由东华大学管理学院的同学精心编写排练的一部反映大学生寝室关系的心理剧，这部剧通过对大学生寝室中的日常矛盾的情景再现，很好的反映出当下大学生寝室关系的微妙与复杂。演员们通过精彩的表演，给予了当前的大学生们对如何处理寝室关系一个很好的指导。</p></div>
            </div>
            <div class="lesson-cast">
            	<div class="cast-tag">标签</div>
                <div class="cast-school"><a target="_blank" href="http://www.dhu.edu.cn/">东华大学</a>&nbsp;&nbsp;管理学院</div>
                <div class="class-tagNames">心理知识微课堂</div>
                <p>时长：13:40分</p>
            </div>
            <hr style="height:1px;border:none;border-top:1px solid #35b558;clear:both" />
            <!--taolun-->
            <div class="lesson-taolun">
                ...
                <div class="all-comments">
                	<div class="allcomment-title"><div>所有评论(<i>1</i>条)</div></div>
                    	...
                    	<div class="commend-ul">
                        	<div class="commend-li">
                                ...
                                <div class="commend-right">
                                	<div class="user-name"><a href="#">爱哭泣的小阿狸</a></div>
                                    <div class="commend-content"><p>真是好啊，我学习到了很多</p></div>
                                    <div class="commend-addtime"><i class="time-i">2015-5-5 12:33</i></div>
                                    <div class="support">赞(<em>12</em>)</div>
                                    <div class="applay">回复(<i class="num-i">999</i>)</div>
                                </div>
