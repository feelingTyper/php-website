    ...
    <div id="container">
    	<div id=center >
        	<ul class="lunbo" id="ul1">
            	<li><a href="lesson.html" target="_blank"><img src="img/glxy_adj.jpg" /></a></li>
                <li><a href="xinliweiketang.html"><img src="img/xlwkt_adj.jpg" /></a></li>
                ...
                <ul class="zuixin-ul" id="zuixin-ul">
                    <li>
                        ...
                        <div class="lesson-info">
                            <h2>清华大学心理教育讲堂</h2>
                            <p class="hide-p">llllllllllllllllllllllllllllllll</p>
           ...
           <div class="teacher-details">
                ...
                <div class="teacher-info">
                    ...
                    <div class="his-lesson">
                       ...
                       <!-- 
                           <div class="his-speech">
                                <div>他的讲座</div>
                                <ul id="speech-ul">
                                    <li><a href = "#">积极心理成就幸福人生</a></li>
                                    <li><a href = "#">积极心理学与幸福组织</a></li>
                                    <li><a href = "#">积极心理成就幸福人生</a></li>
                                    <li><a href = "#">积极心理学与幸福组织</a></li>
